pageextension 50130 CreditLimitExtension extends "Customer Card"
{
    ...
    var
        AreYouSureQst: Label 'Are you sure that you want to set the %1 to %2?', Comment = 'Change confirmation';
        CreditLimitRoundedTxt: Label 'The credit limit was rounded to %1 to comply with company policies.', Comment = 'Information';
        CreditLimitUpToDateTxt: Label 'The credit limit is up to date.', Comment = 'Information';
}